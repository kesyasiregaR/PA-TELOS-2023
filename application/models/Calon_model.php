...
class Calon_model extends CI_Model
{
	...
	public function login($username, $password)
	{
		...
		// bikin session
		$this->session->set_userdata(['id_pengguna' => $user->id_siswa, 'nama_pengguna' => $user->nama_lengkap]);
	...
	{
		$query = 'select * from pendaftaran where id_siswa = "'.$id.'"';		
