				...
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input cost_benefit_type="cost_benefit_type" value="<?= $economic['cost_benefit_type']; ?>" type="text" class="form-control" id="cost_benefit_type" placeholder="cost_benefit_type ">
